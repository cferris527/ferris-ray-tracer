...
void checkered_spheres() {
    ...
    auto checker = make_shared<checker_texture>(0.32, color(.824, 0, 1), color(0, 0, 0));
...
void triangles() {
    ...
    world.add(make_shared<triangle>(point3(-2,-3, 5), vec3(4, 0, 0), vec3(0, 0,-4), earth_surface));
...
void demo_triangle_mesh() {
    ...
    auto difflight = make_shared<diffuse_light>(color(4,4,4));
    world.add(make_shared<sphere>(point3(0,9,0), 2, difflight));
    world.add(make_shared<quad>(point3(3,1,-2), vec3(2,0,0), vec3(0,2,0), difflight));
